          ...
          <div className="bg-white border border-[#e8e6e1] rounded-[2rem] p-6">
            ...
            <div className="space-y-5">
              {skills.map((skill, index) => (
                <div
                  key={index}
                  className="grid grid-cols-4 items-center gap-5 border-b border-[#f2f2f2] pb-4"
                >
                  ...
                  <div>
                    ...
                    <div className="w-full h-2 rounded-full bg-[#ececec] overflow-hidden">
                      <div
                        className={`h-full rounded-full ${skill.color} w-[40%]`}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full h-2 rounded-full bg-[#ececec] overflow-hidden">
                      <div className="h-full rounded-full bg-green-500 w-[80%]"></div>
                    </div>
                  </div>

                  <div className="flex justify-end">
                    <div className="px-4 py-2 rounded-full bg-[#fff3df] text-[#c89a2b] text-sm font-semibold">
                      {skill.gap}
                    </div>
                  </div>
                </div>
            ...
            <button className="w-full h-12 border border-[#e8e6e1] rounded-xl mt-7 flex items-center justify-center gap-2 font-semibold hover:bg-[#f5f1ea] transition-all">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white border border-[#e8e6e1] rounded-[2rem] p-6">
            ...
            <div className="space-y-5">
              {recommendations.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between border border-[#f2f2f2] rounded-2xl p-4"
                >
                  <div>
                  ...
                  <button className="px-5 h-10 rounded-xl bg-[#1d1d1f] text-white text-sm font-medium hover:opacity-90 transition-all">
                    Start
                  </button>
                </div>
              ))}
          ...
          <div className="bg-white border border-[#e8e6e1] rounded-[2rem] p-6">
            ...
            <div className="flex items-center justify-center mb-8">
              <div className="w-52 h-52 rounded-full border-[14px] border-green-500 border-t-orange-400 border-r-red-400 flex items-center justify-center">
            ...
            <button className="w-full h-12 border border-[#e8e6e1] rounded-xl flex items-center justify-center gap-2 font-semibold hover:bg-[#f5f1ea] transition-all">
              View Full Roadmap
